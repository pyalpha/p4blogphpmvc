...
class PostManager extends Manager
{
	...
	{
		$db = $this->dbConnect();
		$query = $db->prepare('SELECT id, LEFT(content, 150) as excerpt, DATE_FORMAT(creation_date, \'%d/%m/%Y à %H:%i\') as creation_date, title as title FROM posts LIMIT :depart, :postsPerPage');
